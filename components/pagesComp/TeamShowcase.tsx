...
import { IconBrandLinkedin, IconBrandX, IconLink,IconBrandFacebook   } from '@tabler/icons-react';
...
export default function TeamShowcase({ members = DEFAULT_MEMBERS }: TeamShowcaseProps) {
  ...
  return (
    <div className=' bg-background w-full py-10 '>
      <div className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-10 lg:gap-14 select-none max-w-7xl w-[95%] mx-auto py-8 px-4 md:px-6 font-sans  ">
      ...
      <div className="flex flex-col sm:grid sm:grid-cols-2 md:flex md:flex-col gap-4 md:gap-5 pt-0 md:pt-2 ">
        {members.map((member) => (
          <MemberRow
            key={member.id}
            member={member}
