  ...
  return (
    <>
      ...
      <button
        ...
        className="flex h-8 items-center gap-2 px-3 py-1 text-sm text-gray-600 bg-background border border-gray-200 dark:border-gray-600 rounded-lg transition-colors"
      >
