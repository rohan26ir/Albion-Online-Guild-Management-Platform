...
const SPRING = { type: 'spring', bounce: 0.16 } as const // NOTE: visualDuration is not present in all framer-motion versions, removing to be safe
const LIFT = { type: 'spring', bounce: 0.32 } as const
